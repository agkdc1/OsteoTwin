...
import { LayoutDashboard, FolderOpen, Box, Volume2, Server, Settings, LogOut, Printer, ShieldAlert } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/audit', icon: ShieldAlert, label: 'Surgical Audit' },
